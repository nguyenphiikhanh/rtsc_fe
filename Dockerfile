...
# ==============================================================================
FROM node:${NODE_VERSION}-bullseye-slim@sha256:a6de496e0a3828ebd898f48a019ee8f3acfd0f3c22f8d26e2d3c70a12e05a801 AS builder
...
COPY --from=nginx-builder /etc/nginx/nginx.conf /rootfs/etc/nginx/conf.d/default.conf
